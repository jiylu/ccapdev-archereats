...
export default function Footer() {
    ...
    return (
        <footer
            className="relative overflow-hidden text-white py-20 px-15 font-['Roboto',sans-serif]"
            style={{ background: "linear-gradient(to right, #1a1a1a, #111)" }}
        >
            <div className="absolute -bottom-6.25 -right-px flex items-center opacity-[0.08] z-0 pointer-events-none">
                ...
                <span
                    ...
                    className="text-[190px] font-extrabold text-white translate-y-8.75 tracking-[-0.03em] leading-[0.8]"
                >
                    rcherEats.
                </span>
            </div>
                ...
                <div className="max-w-100">
                    <div className="flex items-center font-['League_Spartan',sans-serif] text-[47px] font-bold text-white no-underline self-start transition-colors duration-300">
                        <img
                            src="/archer-eats-logo.png"
                            alt="ArcherEats Logo"
                            className="h-11.75 w-auto -translate-x-[2.5px] -translate-y-2.5 pr-0"
                        />
                        <span>rcherEats</span>
                    </div>
                    ...
                    <button
                        onClick={scrollToTop}
                        className="inline-flex items-center gap-2.5 px-5.5 py-3 border-2 border-white rounded-lg bg-transparent text-white text-sm font-medium cursor-pointer transition-all duration-300 hover:bg-white hover:text-black"
                    >
                        Back to Top
                    </button>
                </div>
