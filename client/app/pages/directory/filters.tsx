...
export default function Filters () {
    return (
        <aside className="border-r border-gray w-63 shadow-[1px_0_4px_rgba(0,0,0,0.05)] min-h-screen">
            {/* main container */}
            <div className="flex flex-col p-5">
                <span className="text-xl font-bold mb-5">Filters</span>

                <div className="flex flex-col gap-4.5">
                    {/* open now */}
                    <div className="flex justify-between items-center">
                        <span className="text-base font-bold">Open Now </span>
                        <Switch className="data-[state=checked]:bg-[#1E4D36]" id="open-now" />
                    </div>

                    {/* price range */}
                    <div className="flex flex-col">
                        <span className="text-base font-bold mb-1.5">Price Range</span>
                    ...
                    {/* rating */}
                    <div className="flex flex-col">
                        <span className="text-base font-bold mb-2">Rating</span>
                        <RadioGroup>
                            {["4","3","2","1"].map((val) => (
                                <div className="flex items-center gap-3">
                                    ...
                                    <Label className="flex items-center gap-1">
                                        ...
                                        <span className="text-sm">{val}+ Stars</span>
                                    </Label>
                                </div>
                            ))}
                        </RadioGroup>
                    ...
                    {/* cuisine */}
                    <div className="flex flex-col">
                        <span className="text-base font-bold mb-2">Cuisine</span>
