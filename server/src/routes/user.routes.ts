...
import { addToFavoriteRestaurants, createUser, fetchUserById, removeFromFavoriteRestaurants, updateUserById, checkUsernameAvailability, fetchUserByUsername } from 'controllers/user.controller.js';
